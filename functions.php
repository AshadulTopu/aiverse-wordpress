...
/**
 * aiverse functions and definitions
 *
 ...
 */
 ...
 if ( !function_exists( 'aiverse_setup' ) ):
    /**
     ...
     */
    function aiverse_setup() {
        /*
         * Make theme available for translation.
         * Translations can be filed in the /languages/ directory.
         * If you're building a theme based on aiverse, use a find and replace
         * to change 'aiverse' to the name of your theme in all the template files.
         */
        load_theme_textdomain( 'aiverse', get_template_directory() . '/languages' );
        ...
        register_nav_menus( [
            'main-menu' => esc_html__( 'Main Menu', 'aiverse' ),
            'category-menu' => esc_html__( 'Category Menu', 'aiverse' ),
            'footer-menu' => esc_html__( 'Footer Menu', 'aiverse' ),
        ] );
        ...
        add_theme_support( 'custom-background', apply_filters( 'aiverse_custom_background_args', [
        ...
        add_image_size( 'aiverse-blog', 416, 235, [ 'center', 'center' ] );
    }
endif;
add_action( 'after_setup_theme', 'aiverse_setup' );
 ...
 */
function aiverse_content_width() {
    // This variable is intended to be overruled from themes.
    // Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
    // phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
    $GLOBALS['content_width'] = apply_filters( 'aiverse_content_width', 640 );
}
add_action( 'after_setup_theme', 'aiverse_content_width', 0 );
...
define('AIVERSE_THEME_DIR', get_template_directory());
define('AIVERSE_THEME_URI', get_template_directory_uri());
define('AIVERSE_THEME_CSS_DIR', AIVERSE_THEME_URI . '/assets/css/');
define('AIVERSE_THEME_JS_DIR', AIVERSE_THEME_URI . '/assets/js/');
define('AIVERSE_THEME_INC', AIVERSE_THEME_DIR . '/inc/');
 ...
 */
require AIVERSE_THEME_INC . 'custom-header.php';

/**
 * Functions which enhance the theme by hooking into WordPress.
 */
require AIVERSE_THEME_INC . 'template-functions.php';

/**
 * Custom template helper function for this theme.
 */
require AIVERSE_THEME_INC . 'template-helper.php';
...
// aiverse_comment 
if ( !function_exists( 'aiverse_comment' ) ) {
    function aiverse_comment( $comment, $args, $depth ) {
