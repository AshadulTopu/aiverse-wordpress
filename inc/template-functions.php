 ...
 * @return array
 */
function aiverse_body_classes( $classes ) {
...
add_filter( 'body_class', 'aiverse_body_classes' );
 ...
 * Get tags.
 */
function aiverse_get_tag() {
    $html = '';
    if ( has_tag() ) {
        $html .= '<div class="blog-post-tag"><span>' . esc_html__( 'Post Tags : ', 'aiverse' ) . '</span>';
...
/** img alt-text **/
function aiverse_img_alt_text( $img_er_id = null ) {
    $image_id = $img_er_id;
