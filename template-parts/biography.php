<?php
    ...
    $author_info = get_the_author_meta( 'aiverse_write_by');
    $facebook_url = get_the_author_meta( 'aiverse_facebook' );
    $twitter_url = get_the_author_meta( 'aiverse_twitter' );
    $linkedin_url = get_the_author_meta( 'aiverse_linkedin' );
    $instagram_url = get_the_author_meta( 'aiverse_instagram' );
    $aiverse_url = get_the_author_meta( 'aiverse_youtube' );
    $aiverse_write_by = get_the_author_meta( 'aiverse_write_by' );
